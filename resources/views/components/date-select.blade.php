...
<div class="relative" x-data="{ open: false, selected: 2 }">
    <button
        class="btn justify-between min-w-44 bg-white light:bg-slate-800 border-slate-200 light:border-slate-700 hover:border-slate-300 light:hover:border-slate-600 text-slate-500 hover:text-slate-600 light:text-slate-300 light:hover:text-slate-200"
    ...
    >
        <span class="flex items-center">
            <svg class="w-4 h-4 fill-current text-slate-500 light:text-slate-400 shrink-0 mr-2" viewBox="0 0 16 16">
    ...
    <div
        class="z-10 absolute top-full right-0 w-full bg-white light:bg-slate-800 border border-slate-200 light:border-slate-700 py-1.5 rounded shadow-lg overflow-hidden mt-1"
        ...
        x-cloak
    >
        <div class="font-medium text-sm text-slate-600 light:text-slate-300" x-ref="options">
            <button
                tabindex="0"
                class="flex items-center w-full hover:bg-slate-50 hover:light:bg-slate-700/20 py-1 px-3 cursor-pointer"
