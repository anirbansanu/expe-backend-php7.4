  <div class="col-span-full xl:col-span-6 bg-white light:bg-slate-800 shadow-lg rounded-sm border border-slate-200 light:border-slate-700">
    <header class="px-5 py-4 border-b border-slate-100 light:border-slate-700">
        <h2 class="font-semibold text-slate-800 light:text-slate-100">Customers</h2>
    </header>
    <div class="p-3">
        ...
        <div class="overflow-x-auto">
            <table class="table-auto w-full">
                <!-- Table header -->
                <thead class="text-xs font-semibold uppercase text-slate-400 light:text-slate-500 bg-slate-50 light:bg-slate-700 light:bg-opacity-50">
                    <tr>
                ...
                <!-- Table body -->
                <tbody class="text-sm divide-y divide-slate-100 light:divide-slate-700">
                    <tr>
