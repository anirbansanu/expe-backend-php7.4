<div>
    ...
    <label class="flex items-center justify-center cursor-pointer w-8 h-8 bg-slate-100 hover:bg-slate-200 light:bg-slate-700 light:hover:bg-slate-600/80 rounded-full" for="light-switch">
        <svg class="w-4 h-4 light:hidden" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
        ...
        <svg class="w-4 h-4 hidden light:block" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
