<div class="col-span-full xl:col-span-8 bg-white light:bg-slate-800 shadow-lg rounded-sm border border-slate-200 light:border-slate-700">
    <header class="px-5 py-4 border-b border-slate-100 light:border-slate-700">
        <h2 class="font-semibold text-slate-800 light:text-slate-100">Top Channels</h2>
    </header>
    <div class="p-3">

        <!-- Table -->
        <div class="overflow-x-auto">
            <table class="table-auto w-full light:text-slate-300">
                <!-- Table header -->
                <thead class="text-xs uppercase text-slate-400 light:text-slate-500 bg-slate-50 light:bg-slate-700 light:bg-opacity-50 rounded-sm">
                    <tr>
                        <th class="p-2">
                ...
                <!-- Table body -->
                <tbody class="text-sm font-medium divide-y divide-slate-100 light:divide-slate-700">
                    <!-- Row -->
                    <tr>
                        <td class="p-2">
                            <div class="flex items-center">
                                ...
                                <div class="text-slate-800 light:text-slate-100">Github.com</div>
                            </div>
                        </td>
                        <td class="p-2">
                    ...
                    <tr>
                        <td class="p-2">
                            <div class="flex items-center">
                                ...
                                <div class="text-slate-800 light:text-slate-100">Twitter</div>
                            </div>
                        </td>
                        <td class="p-2">
                    ...
                    <tr>
                        <td class="p-2">
                            <div class="flex items-center">
                                ...
                                <div class="text-slate-800 light:text-slate-100">Google (organic)</div>
                            </div>
                        </td>
                        <td class="p-2">
                    ...
                    <tr>
                        <td class="p-2">
                            <div class="flex items-center">
                                ...
                                <div class="text-slate-800 light:text-slate-100">Vimeo.com</div>
                            </div>
                        </td>
                        <td class="p-2">
                    ...
                    <tr>
                        <td class="p-2">
                            <div class="flex items-center">
                                ...
                                <div class="text-slate-800 light:text-slate-100">Indiehackers.com</div>
                            </div>
                        </td>
                        <td class="p-2">
